...
class ODLNode(object):
    ...
    def description(self):
        return self.xml.get('flow-node-inventory:description')

    @property
    def ip_address(self):
        return self.xml.get('flow-node-inventory:ip-address')

    @property
    def manufacturer(self):
        return self.xml.get('flow-node-inventory:manufacturer')

    @property
    def serial_number(self):
        return self.xml.get('flow-node-inventory:serial-number')

    @property
    def hardware(self):
        return self.xml.get('flow-node-inventory:hardware')

    @property
    def software(self):
        return self.xml.get('flow-node-inventory:software')
